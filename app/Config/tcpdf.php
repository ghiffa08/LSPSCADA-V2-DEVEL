...
define('PDF_HEADER_LOGO', 'logolsp.png');

/**
 * Header logo image width in user units.
 */
//define ('PDF_HEADER_LOGO_WIDTH', 0);
define('PDF_HEADER_LOGO_WIDTH', 38);
 ...
 * Document creator.
 */
define('PDF_CREATOR', 'LSP SMKN 2 Kuningan');

/**
 * Document author.
 */
define('PDF_AUTHOR', 'LSP SMKN 2 Kuningan');

/**
 * Header title.
 */
define('PDF_HEADER_TITLE', 'LEMBAGA SERTIFIKASI PROFESI - P1 SMK NEGERI 2 KUNINGAN');

/**
 * Header description string.
 */
define('PDF_HEADER_STRING', "Jl. Sukamulya No.77, Sukamulya, Kec. Cigugur, Kab. Kuningan, Jawa Barat - 45552\nTelp : (0232) 872930 Fax. (872930) Email : lspp1smkn2kuningan@gmail.com\nWebsite : http://lsp.smkn2-kng.sch.id/");
