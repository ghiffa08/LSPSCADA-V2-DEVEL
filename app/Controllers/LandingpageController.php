...
class LandingpageController extends BaseController
{
    ...
    {
        $dataAPL1 = $this->apl1->getAPL1($id_apl1);
        $dataAPL2 = $this->apl2->getbyId($dataAPL1['id_apl1']);
        $data = [
            ...
            'listSubelemen' => $this->subelemen->getbySkema($dataAPL1['skema_id']),
            'dataAPL2' => $dataAPL2,
        ];
    ...
    {
        $dataAPL1 = $this->apl1->getAPL1($this->request->getPost('id'));
        $listSubelemen = $this->subelemen->getbySkema($dataAPL1['skema_id']);
        ...
        if (!empty($insertData)) {
            ...
            if ($this->jawaban_apl2->insertBatch($insertData)) {
