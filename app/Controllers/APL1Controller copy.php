...
class APL1Controller extends BaseController
{
    ...
    public function pdf($id_apl1)
    {
        ...
        $qr_asesi = generateQrCode(base_url('/scan-tanda-tangan-asesi/' . $dataAPL1['tanda_tangan_asesi']), 'logolsp.png');

        // Generate QR untuk Admin
        $qr_admin = generateQrCode(base_url('/scan-tanda-tangan-admin/' . $tanda_tangan_admin), 'logolsp.png');
        ...
        $data = [
            ...
            'tujuanFormatted' => formatTujuanAsesmen($dataAPL1['tujuan']),
            'statusFormatted' => formatStatus($dataAPL1['validasi_apl1']),
            'buktiDasarFormatted' => formatBuktiDasar($dataAPL1['pas_foto'] ?? null),
            'nama_admin' => $nama_admin,
            'qr_asesi' => $qr_asesi,
            'qr_admin' => $qr_admin,
        ];

        $html1 = view('pdf/apl1_page1', $data);
        $html2 = view('pdf/apl1_page2', $data);
        $html3 = view('pdf/apl1_page3', $data);
