                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group mb-3" role="group" aria-label="Basic example">
                                                ...
                                                <button type="button" class="btn btn-icon btn-danger" data-toggle="modal" data-target="#deleteAsesorModal-<?= $value['userid']; ?>"><i class="fas fa-trash"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                <?php } ?>
...
<?= $this->section('modals') ?>
<!-- Add-User-Modal -->
<form action="<?= url_to('store-asesor') ?>" method="POST">
    <div class="modal fade" id="addAsesorModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<!-- edit-User-Modal -->
<?php foreach ($listAsesors as $key => $value) { ?>
    <form action="<?= site_url('update-asesor') ?>" method="post">
        <div class="modal fade" id="editAsesorModal-<?= $value['userid'] ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Asesor</h5>
...
<!-- delete-Group-Modal -->
<?php foreach ($listAsesors as $key => $value) { ?>
    <form action="<?= site_url('/delete-asesor'); ?>" method="post">
        <div class="modal fade" id="deleteAsesorModal-<?= $value['userid']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Delete Asesor</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
