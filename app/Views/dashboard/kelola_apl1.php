                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group mb-3" role="group" aria-label="Basic example">
                                            ...
                                            <a class="btn btn-icon btn-info" target="_blank" href="<?= base_url('/kelola_apl1/pdf-' . $value['id_apl1']) ?>"><i class="fas fa-eye"></i></a>
                                            <button class="btn btn-icon btn-danger" data-toggle="modal" data-target="#deleteAPL1Modal-<?= $value['id_apl1']; ?>"><i class="fas fa-trash"></i></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php } ?>
...
<?php foreach ($listEmailAPL1 as $row) { ?>

    <form id="setting-form" action="<?= site_url('/kelola_apl1/store-email-validasi'); ?>" method="POST">
...
<?php foreach ($listAPL1 as $row => $value) { ?>
    <form action="<?= site_url('/kelola_apl1/delete'); ?>" method="post">
        <div class="modal fade" id="deleteAPL1Modal-<?= $value['id_apl1']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    $(document).ready(function() {
        $("#dateValidated").change(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('/getDateValidated1') ?>",
                data: {
