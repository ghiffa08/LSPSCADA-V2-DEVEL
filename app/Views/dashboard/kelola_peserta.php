            ...
            <div class="card" id="settings-card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <button class="btn btn-primary" data-toggle="modal" data-target="#addPesertaModal">
                            Tambah Peserta
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group mb-3" role="group" aria-label="Basic example">
                                                <button type="button" class="btn btn-icon btn-info" data-toggle="modal" data-target="#editPesertaModal-<?= $value['userid']; ?>"><i class="fas fa-edit"></i></button>
                                                <button type="button" class="btn btn-icon btn-danger" data-toggle="modal" data-target="#deletePesertaModal-<?= $value['userid']; ?>"><i class="fas fa-trash"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                <?php } ?>
...
<?= $this->section('modals') ?>
<!-- Add-User-Modal -->
<form action="<?= site_url('store-peserta') ?>" method="post">
    <div class="modal fade" id="addPesertaModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?= csrf_field() ?>
                    <p class="text-muted">Masukan Email aktif, Username, Nama Peserta, Nomor Handphone/Whatsapp, Password dan Konfirmasi Password.</p>
                    <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fullname" class="form-control <?php if (session('errors.fullname')) : ?>is-invalid<?php endif ?>" placeholder="Nama Lengkap Asesor">
...
<!-- edit-User-Modal -->
<?php foreach ($listPeserta as $key => $value) { ?>
    <form action="<?= site_url('update-peserta') ?>" method="post">
        <div class="modal fade" id="editPesertaModal-<?= $value['userid'] ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Peserta</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="edit_email" class="form-control <?php if (session('errors.edit_email')) : ?>is-invalid<?php endif ?>" name="edit_email" aria-describedby="emailHelp" placeholder="<?= lang('Auth.email') ?>" value="<?= $value['email'] ?>">
...
<!-- delete-Group-Modal -->
<?php foreach ($listPeserta as $key => $value) { ?>
    <form action="<?= site_url('/delete-peserta'); ?>" method="post">
        <div class="modal fade" id="deletePesertaModal-<?= $value['userid']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Delete Peserta</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
