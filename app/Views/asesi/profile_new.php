...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <p class="form-control-plaintext"><?= $user->fullname ?? $user->nama_lengkap ?></p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group mb-3">
        ...
        <?php if (!$hasAsesiData && !$showDetailForm): ?>
            <div class="text-center mt-4">
                <p class="text-muted">Untuk melengkapi profil dan mendaftar asesmen, silakan tambahkan detail informasi pribadi Anda.</p>
                <a href="<?= current_url() ?>?show_details=1" class="btn btn-primary">
                    <i class="fas fa-plus"></i> Tambah Detail Profil
                </a>
            </div>
        <?php endif; ?>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="form-group mb-3">
                ...
                <textarea class="form-control <?php if (session('errors.alamat')) : ?>is-invalid<?php endif ?>"
                    name="alamat"
                    rows="3"
                    placeholder="Masukan Alamat Lengkap"><?= setFormValue('alamat', $asesi ?? null) ?></textarea>
    ...
    <div class="card">
        <div class="card-body">
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control <?php if (session('errors.nama_perusahaan')) : ?>is-invalid<?php endif ?>"
                    name="nama_perusahaan"
                    value="<?= setFormValue('nama_perusahaan', $asesi ?? null) ?>"
...
<script>
    $(document).ready(function() {
        ...
        const endpoints = {
            kabupaten: '<?= base_url('getKabupaten') ?>',
            kecamatan: '<?= base_url('getKecamatan') ?>',
            desa: '<?= base_url('getDesa') ?>'
        };
