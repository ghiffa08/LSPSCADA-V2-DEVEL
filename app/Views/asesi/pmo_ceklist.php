                        ...
                        <div class="alert alert-info border-left-info">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <p class="mb-0"><?= esc($apl1_data['nama_siswa'] ?? 'N/A') ?> (NIK: <?= esc($apl1_data['nik'] ?? 'N/A') ?>)</p>
                                </div>
                                <div class="col-md-4">
                                    <h6 class="font-weight-bold mb-1"><i class="fas fa-bookmark mr-1"></i>Skema Sertifikasi</h6>
                                    <p class="mb-0"><?= esc($apl1_data['nama_skema'] ?? 'N/A') ?> (<?= esc($apl1_data['kode_skema'] ?? 'N/A') ?>)</p>
                                </div>
                                <div class="col-md-4">
                                    <h6 class="font-weight-bold mb-1"><i class="fas fa-user-tie mr-1"></i>Asesor</h6>
                                    <p class="mb-0"><?= esc($apl1_data['nama_asesor'] ?? 'Belum Ditugaskan') ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
