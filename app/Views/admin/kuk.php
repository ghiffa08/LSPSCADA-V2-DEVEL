...
<h2 class="section-title">Manajemen Kriteria Unjuk Kerja (KUK)</h2>
<p class="section-lead">Kelola semua data KUK untuk setiap elemen kompetensi.</p>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <div class="btn-group">
                        <button class="btn btn-primary" id="btn-add-kuk">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="table-kuk" class="table table-bordered table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Skema</th>
...
<script>
    $(document).ready(function() {
        ...
        dataTable = $('#table-kuk').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": `${baseUrl}/master/kuk/get-data-table`,
                "type": "POST"
            },
            "columns": [{
                "data": null,
        ...
        function loadUnits(skemaId, callback) {
            ...
            $.post(`${baseUrl}/api/get-unit-json`, {
                id_skema: skemaId
            }, (response) => {
        ...
        function loadElemen(unitId, callback) {
            ...
            $.post(`${baseUrl}/api/get-elemen-json`, {
                id_unit: unitId
            }, (response) => {
        ...
        $('#table-kuk tbody').on('click', '.btn-edit', function() {
