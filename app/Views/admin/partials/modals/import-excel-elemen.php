<?= form_open_multipart(site_url('/master/elemen/import'), ['id' => 'import-excel-form']); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-info">
                    ...
                    <a href="<?= site_url('master/elemen/download-template') ?>" class="btn btn-sm btn-primary ml-2">
                        Download Template
                    </a>
                </div>
